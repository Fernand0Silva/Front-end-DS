...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://LuizSilva.somee.com/Disputas";
        ...
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://LuizSilva.somee.com/Personagens/GetAll";
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://LuizSilva.somee.com/PersonagemHabilidades/GetHabilidades";
